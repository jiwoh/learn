...
LOOP W STE 500 HOUSTON, TX 77092.
                ...
                <li>
                  Website refers to LearnCyba, accessible from
                  https://learncyba.com/
                </li>
                <li>
            ...
            <div className="mt-6 text-base space-y-7 text-zinc-600 dark:text-zinc-400">
              ...
              <p className="text-base font-normal tracking-tighter text-zinc-600 dark:text-zinc-200">
                ...
                the Service by or through a mobile device. Tracking Technologies
                and Cookies We use Cookies and similar tracking technologies to
                ...
                Cookies, our Service may use Cookies. Web Beacons. Certain
                ...
                provide You with those services. Cookies Policy / Notice
                Acceptance Cookies Type: Persistent Cookies Administered by: Us
                Purpose: These Cookies identify if users have accepted the use
                of cookies on the Website. Functionality Cookies Type:
            ...
            <div className="mt-6 text-base space-y-7 text-zinc-600 dark:text-zinc-400">
              ...
              <p className="text-base font-normal tracking-tighter text-zinc-600 dark:text-zinc-200">
                ...
                users is among the assets transferred. For other purposes: We
                ...
                analyze the use of our Service, to contact You. For business
                transfers: We may share or transfer Your personal information in
                connection with, or during negotiations of, any merger, sale of
                Company assets, financing, or acquisition of all or a portion of
                Our business to another company. With Affiliates: We may share
            ...
            <div className="mt-6 text-base space-y-7 text-zinc-600 dark:text-zinc-400">
              ...
              <p className="text-base font-normal tracking-tighter text-zinc-600 dark:text-zinc-200">
                ...
                a court or a government agency). Other legal requirements The

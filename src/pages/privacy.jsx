        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            <h1 className="text-3xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-4xl">
              Our PRIVACY mission is to empower you to discover the
              transformative properties of mushrooms and fungi, unlocking your
              full potential in the human experience.
            </h1>
            <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
              <p>
                At RealMush, we believe that including mushrooms and fungi as
              ...
              <p>
                <em>Thank you</em> for choosing RealMush as your go-to source

...
const navigation = {
  solutions: [
    { name: 'Liquid Cultures', href: '/products/category/cultures' },
    { name: 'Jar Lids', href: '/products/category/lids' },
    { name: 'Supplies', href: '/products/category/supplies' },
  ],
  support: [
    { name: 'Articles', href: '/articles' },
    { name: 'Database', href: '/database' },
    { name: 'Recipes', href: '/articles' },
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-base font-[500] leading-6 text-zinc-700 dark:text-emerald-600 lg:text-xl">
                  Shop
                </h3>
          ...
          <div className="mt-10 xl:mt-0">
            ...
            <p className="mt-6 text-sm leading-6 text-zinc-600 dark:text-zinc-200">

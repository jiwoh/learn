        ...
        >
          {navigation.main.map((item) => (
            <div key={item.name} className="pb-6 text-center">
              <a
                href={item.href}
                className="text-sm leading-6 text-zinc-600 hover:text-zinc-900 hover:underline dark:text-zinc-200 dark:hover:text-blue-400"
              >
                {item.name}
              </a>
            </div>
        ...
        <div className="flex justify-center mt-10 space-x-10">
          {navigation.social.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="text-zinc-400 hover:rounded-full hover:text-blue-500 hover:ring-2 hover:ring-blue-600 hover:ring-offset-2"
            >

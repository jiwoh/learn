  ...
  return (
    <section className="relative flex flex-col items-center justify-center h-screen -mt-24 text-center text-white">
      ...
      <div className="... z-10 mx-auto -mt-52 max-w-4xl space-y-4  px-2 py-2 text-center sm:py-8 md:space-x-6 md:px-0 lg:-mt-32 lg:space-y-8 lg:py-6 ">
        <h1 className="mt-4 text-[min(14vw,4.5rem)] font-bold leading-none tracking-tight">
        ...
        <p className="max-w-4xl py-6 mx-auto text-xl leading-normal text-center sm:px-6 text-zinc-200 md:px-12">

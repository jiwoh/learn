    ...
    <section role="region" aria-label="From the Blog">
      <div className="px-4 mx-auto max-w-7xl lg:px-8">
        ...
        <div>
              ...
              {recentArticles.length &&
                recentArticles.map((post) => (
                  <SwiperSlide key={post.slug}>
                    <article className="relative flex flex-col justify-end px-4 pb-8 overflow-hidden border-2 isolate rounded-xl bg-zinc-900 pt-80 hover:ring-1 hover:ring-emerald-600 hover:ring-offset-1 sm:pt-48 lg:pt-80">
                      <Link
          ...
          <div className="mt-8 news-slider__ctr">

...
export function BlockFaqLiquidCulture() {
  return (
    <section aria-labelledby="liquid-culture-steps">
      <div className="mx-2 mx-auto py-8">
        <div className="mx-auto max-w-6xl divide-y divide-zinc-900/10">
          <h2
            id="faqs-liquid-culture"
